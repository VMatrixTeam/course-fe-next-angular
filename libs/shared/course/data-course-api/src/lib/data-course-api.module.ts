...
import { DataApiAccessModule, RouteBasedApiEntity } from '@course-fe-next/shared/basic/data-api-access';
import { provideRouteBasedApiEntity } from '@course-fe-next/shared/basic/util-etc';
